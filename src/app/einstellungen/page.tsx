  ...
  return (
    <AppShell>
      ...
      <section className="grid gap-5 xl:grid-cols-3">
        <Panel>
          <UserCircle className="size-5 text-amber-200" />
          <h2 className="mt-5 text-xl font-semibold text-white">Mein Profil</h2>
          <div className="mt-5">
        ...
        <Panel>
          ...
          <h2 className="mt-5 text-xl font-semibold text-white">Rechte</h2>
          <div className="mt-5">
            {app.group ? (
